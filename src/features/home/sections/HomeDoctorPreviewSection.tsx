...
const DOCTOR_POINTS = [
  {
    title: "Trusted Care",
    description: "Patient-first consultation with clear treatment guidance.",
    Icon: ShieldCheck,
  },
  {
    title: "Daily Chamber",
    description: "Evening OPD schedule for easy appointment booking.",
    Icon: Clock3,
  },
  {
    title: "Easy Location",
    description: "Chamber information and visit support in one place.",
    Icon: MapPin,
  },
];
      ...
      <Container className="relative">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl md:text-5xl">
            Trusted personal care from one dedicated doctor
          </h2>

          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-slate-600 sm:text-base">
            A clean single doctor profile section for patient trust, chamber
            schedule, appointment booking, and professional presentation.
          </p>
        </div>

        {/* Main Clean Doctor Section */}
          ...
          <div className="grid gap-0 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-sky-950 p-5 text-white sm:p-7 md:p-8">
              ...
              <div className="relative">
                ...
                {hasDynamicDoctor ? (
                  <p className="mt-5 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-xs font-medium text-slate-300">
                    Dynamic doctor data connected. You can later replace the
                    static profile text with CMS/API data.
                  </p>
                ) : null}
              </div>
            </div>
